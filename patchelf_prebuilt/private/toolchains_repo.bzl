...
# By default all these toolchains are registered by the patchelf_prebuilt_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:patchelf_prebuilt_toolchain",
    toolchain_type = "@com_booking_rules_patchelf_prebuilt//patchelf_prebuilt:toolchain_type",
